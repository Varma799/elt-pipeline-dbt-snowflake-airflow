...
```bash
git clone https://github.com/umapathi-varma/elt-pipeline-dbt-snowflake-airflow.git
...
Umapathi Varma is a Senior Data Engineer with over 6 years of experience in designing and implementing scalable ETL/ELT pipelines, lakehouse architectures, and cloud-based data warehouses. With a focus on production-grade reliability, he specializes in Python, SQL, Spark, and Snowflake. This repository serves as a reference for modern data orchestration and transformation workflows.

Contact:
- Email: umapathivarma.26@gmail.com
- LinkedIn: www.linkedin.com/in/umapathiv
- GitHub: github.com/umapathi-varma
